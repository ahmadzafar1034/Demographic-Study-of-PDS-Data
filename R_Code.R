# ==============================================================================
# COMPREHENSIVE R SCRIPT - DEMOGRAPHIC ANALYSIS PROJECT
# Pakistani Household Survey Data Analysis
# 
# This script consolidates ALL R codes used in the project:
# 1. Data loading and exploration
# 2. Demographic indicator calculations
# 3. Visualizations and graphs
# 4. Advanced SVM classification analysis
#
# Data Files: Birth.sav, Death.sav, Weights_Assigned.sav, Roster.sav, Fertility.sav
# ==============================================================================
...
# ==============================================================================
# SECTION 2: HOUSEHOLD-LEVEL WEIGHTS PREPARATION
# ==============================================================================

cat("\n========== SECTION 2: PREPARE WEIGHTS ==========\n")

# Get one weight per household (take first Weight value per HCODE)
hh_weights <- weights %>%
  group_by(HCODE) %>%
...
# ==============================================================================
# SECTION 3: DEMOGRAPHIC INDICATORS CALCULATION
# ==============================================================================

cat("\n========== SECTION 3: DEMOGRAPHIC INDICATORS ==========\n")

# 3.1 SEX RATIO (Weighted)
# ============================================================================
cat("\n--- 3.1 SEX RATIO ---\n")
...
# Join birth data with mother's age from weights
asfr_data <- birth %>%
...
# Define age groups: right=FALSE means [15,20), [20,25), etc.
asfr_data <- asfr_data %>%
  mutate(age_group = cut(MOTHER_AGE, 
                         breaks = seq(15, 50, by = 5), 
                         right = FALSE))

# Calculate ASFR for each age group
...
# TFR = sum of ASFR / 1000 * 5 (width of age groups)
...
# Births in reference period (2018-2020)
...
# Infant deaths: IS_ALIVE == 2 AND (YEARS_BABY_LIVED == 0 AND MONTHS_BABY_LIVED == 0)
# OR YEARS_BABY_LIVED < 1
infant_deaths <- birth %>%
  filter(BIRTH_YEAR_BI >= 2018, BIRTH_YEAR_BI <= 2020) %>%
